...
# --- mock ipmininet ---
sys.modules["ipmininet"] = SimpleNamespace()
sys.modules["ipmininet.ipnet"] = SimpleNamespace(IPNet=object)
sys.modules["ipmininet.ipswitch"] = SimpleNamespace(IPSwitch=object)
# ---------------------
...
def test_vlan_to_mst_instance_mapping():
    ...
    node = SimpleNamespace(
        config=SimpleNamespace(mst_instances=mst_instances)
    )
