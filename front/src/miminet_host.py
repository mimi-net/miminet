        ...
        if "config_router_job_select_field" in request.form:
            ...
            if job_id:
                ...
                if job_level < 20:
                    ...
                    if job_id == 104:
                        job_104_arg_1 = request.form.get("config_router_add_subinterface_iface_select_field")
                        job_104_arg_2 = request.form.get("config_router_add_subinterface_ip_input_field")
                        job_104_arg_3 = request.form.get("config_router_add_subinterface_mask_input_field")
                        job_104_arg_4 = request.form.get("config_router_add_subinterface_vlan_input_field")
