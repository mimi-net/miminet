...
class TestJobLimit:
    ...
    def test_add_30_jobs_and_block_31st(self, authorized_page: Page):
    ...
    def test_limit_across_multiple_devices(self, authorized_page: Page):
    ...
    def test_can_add_job_after_deletion(self, authorized_page: Page):
        ...
        delete_result = authorized_page.evaluate(f"""
            () => new Promise((resolve) => {{
                $.ajax({{
                    type: 'POST',
                    url: '/host/delete_job',
