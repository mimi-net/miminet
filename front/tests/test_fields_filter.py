...
class TestFieldsFilter:
    ...
    def test_gateway_filtering(self, selenium: MiminetTester, network: MiminetTestNetwork):
        ...
        assert actual_value == "192.168.1.1", f"The filter failed. Expected '192.168.1.1', received '{actual_value}'"

    def test_host_add_route_gateway_filter(self, selenium: MiminetTester, network: MiminetTestNetwork):
        """
        ...
        assert gw_element.get_attribute("value") == "10.10.10.1", "The gateway field filter did not work"

    def test_router_cidr_notation_add_ip(self, selenium: MiminetTester, network: MiminetTestNetwork):
        """
    ...
    def test_router_cidr_notation_add_route(self, selenium: MiminetTester, network: MiminetTestNetwork):
        """
    ...
    def test_router_cidr_notation_subinterface(self, selenium: MiminetTester, network: MiminetTestNetwork):
        """
